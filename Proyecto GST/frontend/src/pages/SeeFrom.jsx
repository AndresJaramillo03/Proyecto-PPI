...
export default function SeeFrom() {
  ...
  const formularioFiltrado = formulario.filter((f) => {
    if (searchTerm === '') {
      return true;
    }
      ...
      <div className="table-responsive rounded overflow-hidden shadow">
        <table className="table table-bordered table-striped table-hover align-middle">
          ...
          <tbody>
            ...
            {formularioFiltrado.length === 0 && (
              <tr>
                <td colSpan="12" className="text-center">No se encontraron resultados para la búsqueda.</td>
              </tr>
            )}
          </tbody>
        </table>
